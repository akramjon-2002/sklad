...
1. **Панель управления** - главная страница с общей статистикой и быстрыми действиями ([ReportController](controllers/ReportController.php))
...
3. **Быстрая продажа** - сканирование штрихкодов и оформление продаж ([SaleController](controllers/SaleController.php))
...
- [PWA манифест](web/manifest.json) с ярлыками и иконками
...
- **picqer/php-barcode-generator** - генерация штрихкодов (см. [composer.json](composer.json))
...
Если у вас есть вопросы или предложения, создайте [issue в репозитории GitHub](https://github.com/akramjon-2002/sklad/issues). Мы будем рады помочь вам с настройкой и использованием системы!
